...
module.exports = {
  ...
  db: process.env.MONGODB|| 'mongodb://localhost:27017/oznameni',
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1489674451274339',
    clientSecret: process.env.FACEBOOK_SECRET || 'f8d275ba00e5c51bbccadb751abe5a10',
